...
//        System.out.println(new LongestPalindromicSubstring5().checkPalindrome("s"));
        ...
        System.out.println(new LongestPalindromicSubstring5().longestPalindrome2("cbbd") + "-" + "bb");
        System.out.println(new LongestPalindromicSubstring5().longestPalindrome2("babad") + "-" + "bab");
        System.out.println(new LongestPalindromicSubstring5().longestPalindrome2("ss"));
        System.out.println(new LongestPalindromicSubstring5().longestPalindrome2("awerhervragyhaeragdftmsr") + "-" + "rvr");
    }
}
